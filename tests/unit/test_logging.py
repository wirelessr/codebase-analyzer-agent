...
class TestSessionLogs(TestCase):
        ...
        self.sample_log_data = {
            ...
            "execution_timeline": [
                ...
                },
                {
                    ...
                    "data": {
                        "new_findings": ["User model exists"],
    ...
    def test_get_knowledge_before_timestamp(self):
        ...
        knowledge = self.session_logs.get_knowledge_before_timestamp(
            "2024-08-26T10:30:27Z"
        )
        self.assertEqual(knowledge, "User model exists")

        # Test with timestamp before any knowledge updates
        early_knowledge = self.session_logs.get_knowledge_before_timestamp(
            "2024-08-26T10:30:10Z"
        )
        ...
        self.sample_log = {
            ...
            "execution_timeline": [
                ...
                },
                {
                    ...
                    "event_type": "knowledge_update",
                    "data": {
                        "new_findings": ["Found auth module"],
...
class TestStructuredLogger(TestCase):
    ...
    def test_start_session(self):
        ...
        session_id = self.logger.start_session(
            "test query", "/test/path", ["code_analyzer"]
        )
...
class TestEdgeCases(TestCase):
    ...
    def test_session_logs_with_missing_fields(self):
        ...
        minimal_data = {"session_id": "minimal123"}
